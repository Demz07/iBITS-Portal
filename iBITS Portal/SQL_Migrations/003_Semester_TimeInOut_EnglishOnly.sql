-- ========================================================================================
-- iBITS Portal - Semester + Time-In/Time-Out Implementation (ENGLISH ONLY)
-- Version: 2.0 Consolidated Implementation
-- Date: 2025-02-05
-- Fixed: All Chinese characters translated to English, cascade path issues resolved
...
PRINT N'========================================================================';
PRINT N'iBITS Portal - Semester + Time-In/Time-Out Implementation';
...
-- ========================================
-- SECTION 3: UPDATE STUDENT SEMESTERS TABLE (ADD MISSING COLUMNS)
-- ========================================
PRINT N'Updating StudentSemesters table structure...';
...
-- Add SemesterId to Student table
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS 
...
-- ========================================
-- SECTION 10: ENROLL ALL STUDENTS IN CURRENT SEMESTER
-- ========================================
...
BEGIN
    ...
    ([StudentNum], [SemesterId], [YearLevel], [Section], [EnrollmentStatus], [EnrollmentDate])
    SELECT DISTINCT 
        s.StudentNum, 
        @CurrentSemesterId,
        CASE 
...
PRINT N'  ✓ StudentSemesters: Table created with attendance tracking';
