...
namespace iBITS_Portal.Models
{
    ...
    public class Remittance
    {
        ...
        /// </summary>
        [Required]
        public DateTime SubmittedDate { get; set; } = PhTimeHelper.Now;
        ...
        /// </summary>
        public DateTime CreatedAt { get; set; } = PhTimeHelper.Now;
        ...
        /// </summary>
        [NotMapped]
        public int DaysPending => (PhTimeHelper.Now - SubmittedDate).Days;
    }
