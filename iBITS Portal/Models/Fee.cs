// ============================================================
// FILE: Models/Fee.cs
// PURPOSE: Fee records for students with remittance tracking
// ============================================================
using System;
...
public partial class Fee
{
    ...
    // BatchId for grouping manually created fees
    public string? BatchId { get; set; }

    // DateCreated for tracking when the fee was created
    ...
    /// <summary>
    /// Checks if this fee can be edited by Class Treasurer
    ...
    /// <summary>
    /// Checks if this fee is in a submitted remittance batch waiting for validation
    ...
    /// <summary>
    /// Checks if this fee should be visible in Org Treasurer views
    /// Only show if:
