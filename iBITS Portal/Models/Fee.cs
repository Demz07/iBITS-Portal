...
public partial class Fee
{
    ...
    /// <summary>
    /// Checks if this fee is locked (remitted or pending remittance)
    /// </summary>
    [NotMapped]
    ...
    /// </summary>
    [NotMapped]
    public bool CanOrgTreasurerEdit => FeeStatus?.ToUpper() != "PAID" && RemittanceStatus != FeeRemittanceStatus.Remitted;
}
