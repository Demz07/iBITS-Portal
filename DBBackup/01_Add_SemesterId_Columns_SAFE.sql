-- =============================================
-- Semester Historical Records: SAFE Migration
-- Only adds columns to tables that ACTUALLY exist
-- Checks everything before attempting changes
-- =============================================
...
PRINT '========================================';
PRINT 'SAFE MIGRATION - CHECKING TABLES FIRST';
PRINT '========================================';
PRINT '';
