-- =============================================
-- CLEANUP: Keep Only A.Y. 2025-2026 - 1st Semester (FINAL FIX)
-- Handles Student.SemesterId FK constraint
-- =============================================
...
-- =============================================
-- STEP 2: Update Student table (if has SemesterId)
-- =============================================

PRINT 'Checking Student table...';

IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[Student]') AND name = 'SemesterId')
BEGIN
    PRINT '  Student table has SemesterId column';
    
    -- Update all students to target semester
    UPDATE Student SET SemesterId = @TargetSemesterId;
    DECLARE @StudentCount INT = @@ROWCOUNT;
    PRINT '  ✓ Updated ' + CAST(@StudentCount AS VARCHAR(10)) + ' students to target semester';
END
ELSE
BEGIN
    PRINT '  Student table does not have SemesterId column';
END

PRINT '';

-- =============================================
-- STEP 3: Move ALL records to target semester
-- =============================================
...
-- =============================================
-- STEP 4: Handle StudentSemesters
-- =============================================
...
-- =============================================
-- STEP 5: Delete all other semesters
-- =============================================
...
-- =============================================
-- STEP 6: Clean up unused Academic Years
-- =============================================
...
-- =============================================
-- STEP 7: Set target semester as current
-- =============================================
...
PRINT '  3. See dropdown with: ⭐ A.Y. 2025-2026 - 1st Semester';
PRINT '  4. Click gold "New Semester" button to create future semesters';
PRINT '';
PRINT '========================================';
